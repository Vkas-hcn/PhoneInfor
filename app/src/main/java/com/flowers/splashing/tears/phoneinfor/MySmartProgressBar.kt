...
class MySmartProgressBar @JvmOverloads constructor(
    context: Context,
    ...
    fun setProgressBarBgColor(mProgressBarBgColor: Int): MySmartProgressBar {
        this.mProgressBarBgColor = mProgressBarBgColor
        mProgressBarBgPaint.color = mProgressBarBgColor
        return this
    }

    fun setProgressBarBgGradient(mProgressBarBgGradient: Boolean): MySmartProgressBar {
        this.mProgressBarBgGradient = mProgressBarBgGradient
        return this
    }

    fun setProgressBarBgAlpha(mProgressBarBgAlpha: Float): MySmartProgressBar {
        this.mProgressBarBgAlpha = mProgressBarBgAlpha
        mProgressBarBgPaint.alpha = (mProgressBarBgAlpha * 255).toInt()
        return this
    }

    fun setProgressStartColor(mProgressStartColor: Int): MySmartProgressBar {
        this.mProgressStartColor = mProgressStartColor
        return this
    }

    fun setProgressCenterColor(mProgressCenterColor: Int): MySmartProgressBar {
        this.mProgressCenterColor = mProgressCenterColor
        return this
    }

    fun setProgressEndColor(mProgressEndColor: Int): MySmartProgressBar {
        this.mProgressEndColor = mProgressEndColor
        return this
    }

    fun setProgressColorsResId(mProgressColorsResId: Int): MySmartProgressBar {
    ...
    fun reverseProgressColors(): MySmartProgressBar {
    ...
    fun setProgressPositionsResId(mProgressPositionsResId: Int): MySmartProgressBar {
    ...
    fun setBorderColor(mBorderColor: Int): MySmartProgressBar {
        this.mBorderColor = mBorderColor
        mBorderPaint.color = mBorderColor
        return this
    }

    fun setBorderWidth(mBorderWidth: Float): MySmartProgressBar {
        this.mBorderWidth = mBorderWidth
        mBorderPaint.strokeWidth = mBorderWidth
        return this
    }

    fun setPercentTextSize(mPercentTextSize: Float): MySmartProgressBar {
        this.mPercentTextSize = mPercentTextSize
        mPercentTextPaint.textSize = mPercentTextSize
        return this
    }

    fun setPercentTextColor(mPercentTextColor: Int): MySmartProgressBar {
        this.mPercentTextColor = mPercentTextColor
        mPercentTextPaint.color = mPercentTextColor
        return this
    }

    fun setShapeStyle(mShapeStyle: Int): MySmartProgressBar {
        this.mShapeStyle = mShapeStyle
        return this
    }

    fun setRadius(mRadius: Float): MySmartProgressBar {
        this.mRadius = mRadius
        setRadius(mRadius, mRadius, mRadius, mRadius)
        return this
    }

    fun setClockwise(mClockwise: Boolean): MySmartProgressBar {
    ...
    fun setRadii(mRadii: FloatArray): MySmartProgressBar {
        this.mRadii = mRadii
        return this
    }

    fun setIsShowPercentSign(mIsShowPercentSign: Boolean): MySmartProgressBar {
        this.mIsShowPercentSign = mIsShowPercentSign
        return this
    }

    fun setIsShowPercentText(mIsShowPercentText: Boolean): MySmartProgressBar {
        this.mIsShowPercentText = mIsShowPercentText
        return this
    }

    fun setIsAnimated(mIsAnimated: Boolean): MySmartProgressBar {
        this.mIsAnimated = mIsAnimated
        return this
    }

    fun setDuration(mDuration: Long): MySmartProgressBar {
        this.mDuration = mDuration
        return this
    }

    fun setAnimatorUpdateListener(mAnimatorUpdateListener: ValueAnimator.AnimatorUpdateListener?): MySmartProgressBar {
        this.mAnimatorUpdateListener = mAnimatorUpdateListener
        return this
    }

    fun setShowShadow(showShadow: Boolean): MySmartProgressBar {
        this.mShowShadow = showShadow
        return this
    }

    fun setMax(max: Float): MySmartProgressBar {
     ...
     * 设置进度,没有动画
     */
    fun setProgressWithNoAnimation(progress: Float): MySmartProgressBar {
        post {
            cancelProgressAnimation()
     ...
     * 设置进度,利用动画更新进度
     */
    fun setProgress(progress: Float, duration: Long = 0): MySmartProgressBar {
        val delay = when {
            mIsAnimated -> mDuration + 0
            else -> 0
        }
        postDelayed({
            cancelProgressAnimation()
     ...
     * 设置进度,反方向
     */
    fun setProgressReverseDirection(duration: Long = 0): MySmartProgressBar {
        val delay = when {
            mIsAnimated -> mDuration + 0
            else -> 0
        }
        postDelayed({
            cancelProgressAnimation()
            startProgressAnimation(100f, 0f, duration)
        }, delay)
        return this
    }
    ...
    fun addProgressAnimatorUpdateListener(progressAnimatorUpdateListener: ValueAnimator.AnimatorUpdateListener): MySmartProgressBar {
        this.mProgressAnimatorUpdateListener.add(progressAnimatorUpdateListener)
        return this
    }

    fun addProgressAnimatorListener(progressAnimatorListener: Animator.AnimatorListener): MySmartProgressBar {
    ...
    private fun startProgressAnimation(lastProgress: Float, progress: Float, duration: Long) {
        mProgressAnimator.apply {
            ...
            removeAllListeners()
            addUpdateListener(this@MySmartProgressBar)
